...
#define ASP_SAMPLES_PER_READ           (ASP_SAMPLE_RATE / 10)

const int ALSA_REC_CHANNELS = ASP_CHANNELS;
const int ALSA_REC_FRAME_BITS = 16;
const int ALSA_REC_SAMPLE_RATE = ASP_SAMPLE_RATE;
...
#endif // DUEROS_DCS_APP_SAMPLEAPP_ALSARECORDER_H_
