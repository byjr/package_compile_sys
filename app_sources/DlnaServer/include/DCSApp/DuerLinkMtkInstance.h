...
#if defined(CONFIG_PANTHER)
#define DUERLINK_NETWORK_DEVICE_MTK_FOR_AP "wlan0"
#define DUERLINK_NETWORK_DEVICE_MTK_FOR_WORK "sta0"
#else
...
#if defined(CONFIG_PANTHER)
#define DUERLINK_WPA_HOSTAPD_CONFIG_FILE_PATH_MTK "/var/run/hostapd.conf"
#define DUERLINK_WPA_HOSTAPD_PID_FILE_PATH_MTK "/var/run/hostapd.pid"
#else
#define DUERLINK_WPA_HOSTAPD_CONFIG_FILE_PATH_MTK "/etc/hostapd_mtk.conf"
#endif

#if defined(CONFIG_PANTHER)
#define DUERLINK_WPA_CONFIG_FILE_MTK "/var/run/wpa.conf"
#else
...
#define PING_DEST_HOST1     "180.76.76.76"
#define PING_DEST_HOST2     "114.114.114.114"
...
private:
    ...
    static duerLink::NetworkConfigStatusObserver *m_pMtkConfigObserver;
