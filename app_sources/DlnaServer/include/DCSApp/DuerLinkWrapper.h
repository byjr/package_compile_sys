...
#define isDuerLinkNetworkReady() (\
	(DUERLINK_NETWORK_SUCCEEDED == DuerLinkWrapper::getInstance()->getNetworkStatus()) ||\
...
public:
	...
	void registerRfreshAccessToken(set_refresh_access_token_t getAccessToken);
    void release();
...
#else
//    void initDuerLink(const std::string& accessToken, const std::string& clientId,set_refresh_access_token_t getAccessTokenCallback);
	void initDuerLink();
...
private:
    ...
    /// is network online
    volatile bool m_isNetworkOnline;
