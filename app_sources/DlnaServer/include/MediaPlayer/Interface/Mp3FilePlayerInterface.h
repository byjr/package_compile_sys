...
enum FilePlayType {
    FILE_PLAYTYPE_ALERTS,
    FILE_PLAYTYPE_PROMPT
};
...
public:
    ...
    virtual void registerListener(std::shared_ptr<AudioPlayerListener> notify, FilePlayType type) {}

    virtual void setFilePlayType(FilePlayType type) {}
