...
// the class factories
extern "C" std::shared_ptr<duerOSDcsApp::application::AlsaAudioMicroponeWrapper> create(std::shared_ptr<duerOSDcsSDK::sdkInterfaces::DcsSdk> dcsSdk) {
...
//void AlsaAudioMicroponeWrapper::setListenStarted(bool start) {
//}
//#endif
