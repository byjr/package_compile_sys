...
void H264Split::nuhVctInit(std::vector<NaluHead *> &nuhVct) {
	const char shortNh[] = {0, 0, 1};
	mH264Nu2h = {shortNh, sizeof(shortNh)};
	nuhVct.push_back(&mH264Nu2h);

	const char longNh[] = {0, 0, 0, 1};
	mH264Nuh1 = {longNh, sizeof(longNh)};
	nuhVct.push_back(&mH264Nuh1);
}
#if 0
...
int BinSplit_main(int argc, char *argv[]) {
	...
	BinSplitPar mPar = {
		.iPath = "/home/jonny/media/enc.264",
